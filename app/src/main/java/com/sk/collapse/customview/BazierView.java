 ...
 */
public class BazierView extends FrameLayout {
...
//        tipImageView.setImageResource(R.drawable.bazierspring_bg_selector);
//        tipImageView.setBackgroundResource(R.drawable.skin_tips_newmessage_ninetynine);

        tipImageView = (TextView)new TextView(getContext());
        ViewGroup.LayoutParams lp = new ViewGroup.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        tipImageView.setLayoutParams(lp);
        tipImageView.setGravity(Gravity.CENTER);
        tipImageView.setTextSize(13);
        tipImageView.setTextColor(Color.WHITE);
        tipImageView.setText("12");
        tipImageView.setBackgroundResource(R.drawable.bazierspring_bg_selector);
...
//        exploredImageView.setY(startY - exploredImageView.getHeight()/2);
        ...
        tipImageView.setX(startX);
        tipImageView.setY(startY);
