...
import com.sk.collapse.model.BannerAdapter;
...
public class BannerView extends RelativeLayout implements BannerAdapter.ViewPagerOnItemClickListener
{
    ...
    public BannerView(Context context, AttributeSet attrs, int defStyleAttr)
    {
        ...
        View v = (View) LayoutInflater.from(context).inflate(R.layout.layout_custom_banner, this, true);
        viewPager = (ViewPager) v.findViewById(R.id.layout_banner_viewpager);
        points = (LinearLayout) v.findViewById(R.id.layout_banner_points_group);
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 1:
                    ...
                    if(curIdx < viewPager.getChildCount()-1 && curIdx >= 0) {
                        curIdx++;

                    }else if(curIdx < 0) {
                        curIdx = viewPager.getChildCount()-1;
                    }else{
                        curIdx = 0;
                    }
                    viewPager.setCurrentItem(curIdx);
                    break;
            }
        }
    };
